...
export function CodingQuestion({ weekNumber, questionNumber }: CodingQuestionProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <p>
        {/* This would be replaced with the actual question text */}
        Write a function that solves the following problem: [Problem description for Week {weekNumber}, Question{" "}
        {questionNumber}]
      </p>
      <Textarea
        value={code}
